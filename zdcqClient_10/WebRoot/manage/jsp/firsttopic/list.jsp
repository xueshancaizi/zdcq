	...
	<HEAD>
	   ...
	   <script type="text/javascript">
			...
			$(document).ready(function(){
				$("#add").click(function(){
					window.location.href = "${pageContext.request.contextPath}/firstTopicAction_addUI.action"
				})
			})
		</script>
	</HEAD>
								...
								<s:iterator value="#list" >							      
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px" width="7%">
												<s:a action="firstTopicAction_updateUI.action?fid=%{fid}">
													<img src="${pageContext.request.contextPath}/manage/images/button_view.gif" border="0" style="CURSOR: hand">
												</s:a>
											</td>
											<td align="center" style="HEIGHT: 22px" width="7%">
												<s:a action="firstTopicAction_delete.action?fid=%{fid}">
