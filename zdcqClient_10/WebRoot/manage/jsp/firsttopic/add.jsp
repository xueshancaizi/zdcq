...
<HTML>
	...
	<body>
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/firstTopicAction_add.action" method="post" enctype="multipart/form-data">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>添加一级栏目信息</STRONG>
						</strong>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" >
					    <s:textfield id="fid" name="fid"></s:textfield>
					</td>
