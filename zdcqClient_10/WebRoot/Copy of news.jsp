...
<body>
	...
	<!--------------Header--------------->
	<header style="height: 135px; width: 100%; margin-bottom: 5px;">
		<div class="zerogrid" style="margin-top: -12px">
...
<div id="menu2" class="menu">
	<ul>
	<li><a href="#" onclick="javascript:fenjuxinxi('0')"  style="cursor:pointer;">首 页</a></li>
	...
	<li><a href="#" onclick="javascript:fenjuxinxi('${f.fjId}')"  style="cursor:pointer;cursor:hand;"  >${f.fjName}</a></li>
  ...
  <div id="mainDiv" style="width: 1002px; border: 1px solid #cccccc;">
        ...
        <div id="contentDiv2">
			...
			<tr>
				...
				<td align="right"  style="padding-right: 10px;">【<a style="text-decoration:none;"href="${pageContext.request.contextPath}">返回首页</a>】	
