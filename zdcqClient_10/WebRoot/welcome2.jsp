...
<body>
	...
	<header>
		<div class="zerogrid">
		   <img src="${pageContext.request.contextPath}/images/PNG/${fjInfo.fjId}.PNG" height="100px" width="1002px"> 
		
			 <!-- <img src="${pageContext.request.contextPath}/images/headerBg.jpg">  -->
	  
		<OBJECT WIDTH="1002px" HEIGHT="140px">
		<PARAM NAME=movie VALUE="${pageContext.request.contextPath}/images/swf/1028_1.swf"> 
		<EMBED src="${pageContext.request.contextPath}/images/swf/1028_1.swf" WIDTH="1002px" HEIGHT="140px" NAME="2" ALIGN=""></EMBED>
		</OBJECT>	
...
<!-- 代码 结束 -->
	...
	<div style="width:1002px; height:80px; margin:0 auto; vertical-align:middle; padding-top:-2px; font-family: 宋体; font-size: 16px;">
	   ...
	   <tr align="center" style="vertical-align:middle;" >
				<td align="center" style=" background: #069; text-align:center;vertical-align:middle;" onmouseover="javascript:MySetBackColor2(this, 0)" onmouseout="javascript:MySetBackColor1(this, 0)" >    
					 <a onclick="javascript:fenjuxinxi('0')" style="text-decoration:none; text-align: center; vertical-align:middle;cursor:pointer;"  target="select"><font id="myfont0" style="font-family:宋体; color:#FFFFFF;">首页</font></a>			   
			    </td>
	      <c:forEach items="${fenJuList}" var="f" varStatus="fs">	
		   ...
		   <a href="#" onclick="javascript:fenjuxinxi('${f.fjId}')"  style="cursor:pointer;cursor:hand; text-decoration:none; text-align: center; vertical-align:middle; "  target="select"><font id="myfont${fs.count}" style="font-family:宋体; color:#ffffff;">${f.fjName}</font></a>	
		   
		    <!--  
		   <a  style="text-decoration:none; text-align: center; vertical-align:middle;"  href="${pageContext.request.contextPath}/servlet/ControllerSevlet?op=fjxx&fjId=${f.fjId}" target="select"><font id="myfont${fs.count}" style="font-family:宋体; color:#FFFFFF;">${f.fjName}</font></a>	
		  -->
		...
		<div class="zerogrid">
							...
							<div class="content" style="padding: 20px 0px 0px 0px;" >
								<ul class="list">
								    <c:forEach items="${f.secondTopic}" var="s" varStatus="fs">
								    	...
								    	<a style="padding: 8px 20px; margin: 0px 10px 10px 0px; background-color:#FFC;" href="${pageContext.request.contextPath}/VisitAction_sectionInfo.action?fjId=${sessionScope.fjId}&sid=${s.sid}" target="select" onmouseover="javascript:MySetBackColor3(this, ${s.sid})" onmouseout="javascript:MySetBackColor4(this, ${s.sid})"><font id="mfont${s.sid}" style=" font-size: 16px; font-family: 微软雅黑; color: #436EEE;">${s.name}</font></a></li>
								    </c:forEach>
								</ul>
							</div>
					    </section>
		   ...
		   <script type="text/javascript">
	        function MySetBackColor3(object, index){
				object.style.backgroundColor="#E0FFFF";
			...
			function MySetBackColor4(object, index){
				object.style.backgroundColor="#FFC";
